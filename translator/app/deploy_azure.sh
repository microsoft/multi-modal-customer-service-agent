...
# Variables  
RESOURCE_GROUP="rg-translator"  
LOCATION="westus"  # Change to your preferred location  
CONTAINER_REGISTRY="translatorassistant"  
CONTAINER_ENVIRONMENT="translator-assistant-env"  
IMAGE_NAME="translator-assistant:latest"  
