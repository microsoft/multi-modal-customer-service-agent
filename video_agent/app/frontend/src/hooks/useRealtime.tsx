...
export default function useRealTime({
    ...
    // Function to send a user's text message (ConversationItemCreateCommand)  
    const addUserMessage = (text: string) => {  

        const command: ConversationItemCreateCommand = {  
        ...
        console.log("Sending user message:", command);
        sendJsonMessage(command);  
    };  
    ...
    return { startSession,addUserMessage, addUserAudio, inputAudioBufferClear };
}
